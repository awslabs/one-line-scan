...
rm -rf SP
../../../one-line-scan -o SP --stop-after-fail --no-analysis --cbmc -- gcc -Wextra fail.c || exit 1

# when using an additional -Werror, the compilation should fail
rm -rf SP
../../../one-line-scan -o SP --extra-cflags -Werror --no-analysis --cbmc -- gcc -Wextra fail.c || exit 0
